...
const STR = {
  ...
  heliHint: {
    ...
    en: "Official bulletin from Bahrain's Meteorological Directorate — winds and temperature from the surface to FL390, freezing level, tropopause, and icing warnings for a 50km radius around Bahrain International Airport. Refreshed roughly every 6 hours — always check the \"Valid from / to\" line printed inside the document itself for the exact current window.",
  },
